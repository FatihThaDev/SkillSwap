 ...
 *   ),
 *   @OA\Response(response=200, description="Courses retrieved successfully"),
 *   @OA\Response(response=404, description="No courses found for this category")
 * )
 */
 ...
 *   ),
 *   @OA\Response(response=200, description="Courses retrieved successfully"),
 *   @OA\Response(response=404, description="No courses found for this instructor")
 * )
 */
 ...
 *   summary="Delete a course as a specific instructor",
 *   tags={"Courses"},
 *   @OA\Parameter(name="user_id", in="path", required=true, description="User ID", @OA\Schema(type="integer")),
 *   @OA\Parameter(name="course_id", in="path", required=true, description="Course ID", @OA\Schema(type="integer")),
 *   @OA\Response(response=200, description="Course deleted by instructor successfully"),
 *   @OA\Response(response=404, description="Course or instructor not found")
 * )
 */
